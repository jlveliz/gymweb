...
@section('title','Registro Miembros')
...
@section('content-page')
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2 class="animated fadeIn">Registro Miembros</h2> 
				...
				<div class="x_content">
					<ul class="nav nav-tabs" role="tablist">
					    <li role="presentation" class="active"><a href="#listLogmember" aria-controls="listLogmember" role="tab" data-toggle="tab"> <i class="fa fa-list"></i> Listado</a></li>
					</ul>
					<div class="tab-content tab-gym-index">
						<div role="tabpanel" class="tab-pane active" id="listMember">
							<table id="member-access-datatable" class="table table-striped dt-responsive nowrap table-gym animated fadeIn" cellspacing="0" width="100%">
								<thead>
									<tr>
								...
								<tbody>
									@foreach ($registers as $register)
										<tr>
											...
											<td>{{$register->member->name}} {{$register->member->last_name}} </td>
...
@section('js')
 ...
 <script type="text/javascript">
 	$(document).ready(function(){
    	$('#member-access-datatable').DataTable({
    		"language": {
