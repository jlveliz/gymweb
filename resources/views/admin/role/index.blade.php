				...
				<div class="x_content">
					...
					<div class="tab-content tab-gym-index">
						<div role="tabpanel" class="tab-pane active" id="listMember">
							<table id="role-datatable" class="table table-striped dt-responsive nowrap table-gym animated fadeIn" cellspacing="0" width="100%">
								<thead>
									<tr>
											...
											<td class="text-center">
												<div class="btn-group">
													...
													<ul class="dropdown-menu">
														<li>
															<a href="{{ route('admgym.roles.edit',$role->id) }}" title="Crear"><i class="fa fa-pencil"></i> Editar</a>
														</li>
														<li>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <p class="col-md-11 col-sm-11 col-xs-12">
	        	Está seguro de eliminar el rol <b id="role_delete"></b>
	        </p>
	        <div class="clearfix"></div>
	      </div>
...
<script src="{{ asset('public/js/role/app.js') }}" type="text/javascript"></script>
@endsection