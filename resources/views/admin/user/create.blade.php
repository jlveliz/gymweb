				...
				<div class="x_content">
					<ul class="nav nav-tabs" role="tablist">
					    <li><a href="{{ route('admgym.users.index') }}"> <i class="fa fa-list"></i> Listado</a></li>
					      <li role="presentation" class="active"><a href="#" aria-controls="listUser" role="tab" data-toggle="tab"><i class="fa fa-plus"></i> Crear</a>
	                    </li>
					</ul>
					<div class="tab-content tab-gym-index">
						<div role="tabpanel" class="tab-pane active" id="listUser">
							<form method="post" class="form-label-left animated fadeIn" action="{{ route('admgym.users.store') }}">
