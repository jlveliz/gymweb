			...
			<div class="x_panel">
				...
				<div class="x_content">
					<ul class="nav nav-tabs" role="tablist">
					    <li><a href="{{ route('permissions.index') }}"> <i class="fa fa-list"></i> Listado</a></li>
					...
					<div class="tab-content tab-gym-index">
						<div role="tabpanel" class="tab-pane active" id="listPermissions">
							<form method="post" class="form-label-left animated fadeIn" action="{{ route('permissions.update',$permission->id) }}">
