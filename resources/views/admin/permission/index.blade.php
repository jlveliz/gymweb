									...
									@foreach ($permissions as $permission)
										<tr>
											...
											<td class="text-center">
												<div class="btn-group">
												    <a class="btn btn-default btn-sm" href="{{ route('permissions.edit',$permission->id) }}" title="Crear"><i class="fa fa-pencil"></i> Editar</a>
													<a class="btn btn-default btn-sm delete-permission" href="#" title="Eliminar" data-id="{{$permission->id}}" data-permission="{{ $permission->display_name }}"> <i class="fa fa-trash"></i> Eliminar</a>
												</div>
											</td>
										</tr>
									@endforeach
