				...
				<div class="x_content">
					...
					<div class="tab-content tab-gym-index">
						<div role="tabpanel" class="tab-pane active" id="editMember">
							<form method="post" class="form-label-left animated fadeIn" action="{{ route('admgym.members.update',$member->id) }}" enctype="multipart/form-data">
									...
									<div class="row">
										...
										<div class="form-group col-md-2 col-sm-2 col-xs-4 @if ($errors->has('gender')) has-error @endif">
											...
											<select name="gender" id="gender" class="form-control">
												<option value="null" @if($member->gender == 'null') selected @endif>--Seleccione--</option>
												<option value="male" @if($member->gender == 'male') selected @endif>Masculino</option>
												<option value="female" @if($member->gender == 'female') selected @endif>Femenino</option>
											</select>
